...
namespace Enet
{
    ...
    public sealed unsafe class ManagedEnetHost : IIsCreated, IDisposable
    {
        ...
        public int Ping(ENetAddress address) => _handle.Ping(address);
        ...
        /// </remarks>
        public EnetPeer Connect(ENetAddress address, nuint channelCount, uint data) => _handle.Connect(address, channelCount, data);
        ...
        /// </remarks>
        public int Service(uint milliseconds, out EnetEvent @event) => _handle.Service(milliseconds, out @event);
