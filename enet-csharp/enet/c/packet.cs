...
namespace enet
{
    ...
    {
        public static ENetPacket* enet_packet_create(void* data, nint dataLength, uint flags)
        {
        ...
        public static int enet_packet_resize(ENetPacket* packet, nint dataLength)
        {
            byte* newData;
        ...
        public static uint enet_crc32(ENetBuffer* buffers, nint bufferCount)
        {
            uint crc = 0xFFFFFFFF;
