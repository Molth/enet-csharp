...
namespace enet
{
    ...
    {
        /// <summary>
        ///     Allocates a new range coder context for packet compression.
        /// </summary>
        /// <returns>A pointer to the new context, or <see langword="null" /> on allocation failure.</returns>
        ...
        /// <summary>
        ///     Frees a range coder context previously created by <c>enet_range_coder_create</c>.
        /// </summary>
        ...
        /// <summary>
        ///     Halves the counts of a symbol subtree and recomputes the under totals to keep counts bounded.
        /// </summary>
        /// <param name="symbol">The root of the subtree to rescale.</param>
        /// <returns>The total count of the rescaled subtree.</returns>
        ...
        /// <summary>
        ///     Compresses a set of input buffers into the output buffer using the range coder.
        /// </summary>
        /// <param name="context">The range coder context.</param>
        ...
        /// <summary>
        ///     Decompresses a range coded buffer back into the output buffer.
        /// </summary>
        /// <param name="context">The range coder context.</param>
