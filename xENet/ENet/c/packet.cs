...
namespace enet
{
    ...
    {
        /// <summary>
        ///     The CRC-32 lookup table used by the packet checksum computation.
        /// </summary>
        ...
        public static void enet_host_checksum_with_crc32(ENetHost* host) => enet_host_checksum(host, &enet_crc32);
    }
}