...
namespace ThreadedEnet
{
    ...
    public sealed class ThreadedManagedEnetHost : IDisposable
    {
        ...
        /// <param name="uid">The unique id of the newly connected peer.</param>
        ...
        /// </summary>
        /// <param name="host">The host that raised the event.</param>
        /// <param name="uid">The unique id of the disconnected peer.</param>
        ...
        /// </summary>
        /// <param name="host">The host that raised the event.</param>
        /// <param name="uid">The unique id of the peer that sent the packet.</param>
...
#pragma warning restore CA1816 // Call GC.SuppressFinalize correctly.
        ...
        /// </summary>
        /// <param name="uid">The unique id of the peer to disconnect.</param>
        ...
        /// </summary>
        /// <param name="uid">The unique id of the target peer.</param>
