...
namespace Enet
{
    ...
    public readonly unsafe struct EnetPeer : IIsCreated
    {
        ...
        ///     the constant <see cref="ENet.ENET_PEER_PACKET_LOSS_SCALE" />.
        /// </summary>
        ...
        /// </summary>
        /// <param name="pingInterval">The interval in milliseconds; defaults to <see cref="ENet.ENET_PEER_PING_INTERVAL" /> if 0.</param>
        ...
        /// <remarks>
        ///     An <see cref="EnetEventType.Disconnect" /> event will be generated by
        ///     <see cref="EnetHost.Service(uint, out EnetEvent)" /> once the disconnection is complete.
        /// </remarks>
